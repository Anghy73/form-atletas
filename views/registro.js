const registro = () => {
  return `
    <form class="form" id="form">
      <h3 class="form__title">Registro de Atletas</h3>
      ...
      <div class="form__buttons">
        <button class="form__button" type="button" id="btnLimpiar">Limpiar</button>
        <button class="form__button" type="submit" id="btnGuardar">Guardar</button>
      </div>
    </form>
  `
}
